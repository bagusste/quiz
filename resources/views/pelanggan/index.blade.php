    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-dark bg-gradient">
            <div class="container-fluid">
                <a class="navbar-brand text-light fs-2" href="dashboard">SI-PLN</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link text-light" aria-current="page" href="pelanggan">Pelanggan</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-light" href="golongan">Golongan</a>
                        </li>
                        <li class="nav-item">
        ...
        <a href="pelanggan/create" class="btn btn-success mb-2">Tambah Pelanggan</a>
            <table class="table table-striped">
                ...
                <tr>   
                    ...
                    <td class="text-center" style="width:50px;"><a href="pelanggan/edit/{{ $row->id }}" class="badge text-bg-primary text-decoration-none">Edit</a></td>
